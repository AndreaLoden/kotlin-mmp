...
object Deps {
    ...
    object Libs {
        object Android {
            ...
            val kotlinxt = AndroidLibrary(
                name = "androidx.core:core-ktx:${Versions.Libs.Android.kotlinxt}"
            )
            ...
            val swiperefreshlayout = AndroidLibrary(
                name = "androidx.swiperefreshlayout:swiperefreshlayout:${Versions.Libs.Android.material}"
            )
        }
